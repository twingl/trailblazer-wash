...
export default class VoteMinNeutral extends React.Component {
  ...
  render() {
    var classes = this.state.rank === 0 ? "neutral button button-secondary min selected" : "neutral button button-secondary min";
    return  <a onClick={this.onClick.bind(this)} className={classes} >
                <img src="/assets/icons/neutral.svg" />
            </a>;
  }
